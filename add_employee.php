...
<br>
  ...
  <form method="post" action="add_employee.php">
    ...
    <div class="container"> 
    <div class="form-group">
          <label class="control-label col-sm-2" for="Employee">Trainee ID</label>
          <div class="col-sm-10">
            <input type="text" class="form-control"  placeholder="Enter Trainee ID" name="trainee_id">
            <br>
          </div>
      </div>
    </div>
    ...
    <div class="container">	
     ...
     <div class="container">  
    <div class="form-group">
          <label class="control-label col-sm-2" for="phone">Department:</label>
          <div class="col-sm-10">
